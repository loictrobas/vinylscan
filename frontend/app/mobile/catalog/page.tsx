...
import { Search, X, ChevronDown, Loader2, Check, DollarSign, ExternalLink, Disc3 } from "lucide-react";
      ...
      <div className="px-4">
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-4 py-16 text-center">
            ...
            <p className="text-sm font-medium text-vs-text-2">No records found</p>
          </div>
        ) : (
          <>
